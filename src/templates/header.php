							...
							<ul>
								...
								<?php 
									if (isset($_SESSION['employee']['id_employee'])) { ?>
										...
										<li><a href="/logout" id="login-link"><span class="icon solid fa-envelope">Log out</span></a></li>
								<?php } else { ?>
									
									<li><a href="/login" id="logout-link"><span class="icon solid fa-envelope">Log in</span></a></li>
									<li><a href="/registration" id="logout-link"><span class="icon solid fa-envelope">Registration</span></a></li>
								<?php } ?> 
							</ul>
						</nav>
