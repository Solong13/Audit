...
class EmployeeSalaryCalculationService 
{
    ...
    public function salaryCalculation(array $data)
    {
// від балди денні години за червень 2025
    ...
    $current_position = $this->employeeModel->getCurrentPosition($all_data["id_position"]);
    ...
    if (isset($all_data["id_salary"])) {
        $this->employeeModel->updataSalary($_POST["id_salary"], $all_data);
    } else {
        unset($all_data['id_position']);
        $this->employeeModel->salaryRecord($all_data);
    }
    }
}