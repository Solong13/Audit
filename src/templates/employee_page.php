...
<main>
  ...
  <div class="profile-section">
    <div class="photo-upload">
      <form action="/emoloyee" method="post" enctype="multipart/form-data">
        <img src=<?= '/'.$data['for_profil']['photo'] ??"/assets/images/avatar.jpg"?> alt="Фото працівника">
        <input type="file" name="image">
        <input type="hidden" name="id_employee" value="<?= $data[0]['id_employee'] ??  $theNewEmployee['id_employee']?>">
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td></td>
          <td class="actions">
            <?php //&&id_employee=<?=$_SESSION['id_for_salary'] ?>
            <a href="?page=edit_salary&&id_salary=<?=$employee['id']?>"><button class="edit-btn">Edit</button></a>
