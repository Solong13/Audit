				...
				<div class="top">
					...
					<!-- Logo -->
						<div id="logo">
							...
							<h1 id="title"><?= isset($_SESSION['login']) ? $_SESSION['login'] : 'ПІП'?></h1>
							<p><?= isset($_SESSION['table_number']) ? $_SESSION['table_number'] : '*****'?></p>
						</div>
							...
							<ul>
								...
								<?php 
									if (isset($_SESSION['login'])) { ?>
										<li><a href="/logout.php" id="contact-link"><span class="icon solid fa-envelope">Log out</span></a></li></ul>
								<?php } else { ?>
									<li><a href="/login.php" id="contact-link"><span class="icon solid fa-envelope">Log in</span></a></li>
								<?php } ?> 
							</ul>
						</nav>
